...
def init(default_matcap:core.Texture, *, render_node:core.NodePath = None, light_dir:core.Vec3 = None):
    ...
    return Pipeline(default_matcap, render_node=render_node, light_dir=light_dir)
